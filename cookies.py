...
time.sleep(2)
###os.system(f'xdg-open https://t.me/DEVIL_DECODER')
#------------------[ ROSAN ]-------------------#
#------------------[ USER-AGENT ]-------------------#
ugen2=[]
ugen=[]
...
Author  : rosan
   Telegram: ‌@DEVIL_DECODER
 NAME tool: rosan13.py
BAXERBEN BO TOOL rosan
HAR KESHAYAKTAN HABW SARDANI TELEGRAM KAN @DEVIL_DECODER
              welcome all ilove you all
.1chit crak krd skren bnera bo @DEVIL_DECODER
------------------------------------------------------------                                                                                  ------------------------------------------------------------"""
os.system('clear')
print(logo)
